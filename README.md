...
Atlas API keys Configuration re required both cloud formation and CDK resources, and this key pair are provided as input by the use of a Profile

to configure the API keys and a secret profile follow the next steps:
## 1. Configure your ATLAS API KEYS
