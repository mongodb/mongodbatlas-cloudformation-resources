...
| <code><a href="#@mongodbatlas-awscdk/alert-configuration.CfnAlertConfiguration.property.attrLinks">attrLinks</a></code> | <code>any[]</code> | Attribute `MongoDB::Atlas::AlertConfiguration.Links`. |
| <code><a href="#@mongodbatlas-awscdk/alert-configuration.CfnAlertConfiguration.property.attrResults">attrResults</a></code> | <code>any[]</code> | Attribute `MongoDB::Atlas::AlertConfiguration.Results`. |
...
##### `attrLinks`<sup>Required</sup> <a name="attrLinks" id="@mongodbatlas-awscdk/alert-configuration.CfnAlertConfiguration.property.attrLinks"></a>
...
##### `attrResults`<sup>Required</sup> <a name="attrResults" id="@mongodbatlas-awscdk/alert-configuration.CfnAlertConfiguration.property.attrResults"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@mongodbatlas-awscdk/alert-configuration.CfnAlertConfigurationProps.property.apiKeys">apiKeys</a></code> | <code><a href="#@mongodbatlas-awscdk/alert-configuration.ApiKeyDefinition">ApiKeyDefinition</a></code> | *No description.* |
| <code><a href="#@mongodbatlas-awscdk/alert-configuration.CfnAlertConfigurationProps.property.enabled">enabled</a></code> | <code>boolean</code> | Flag that indicates whether someone enabled this alert configuration for the specified project. |
...
##### `apiKeys`<sup>Optional</sup> <a name="apiKeys" id="@mongodbatlas-awscdk/alert-configuration.CfnAlertConfigurationProps.property.apiKeys"></a>
...
##### `enabled`<sup>Optional</sup> <a name="enabled" id="@mongodbatlas-awscdk/alert-configuration.CfnAlertConfigurationProps.property.enabled"></a>
