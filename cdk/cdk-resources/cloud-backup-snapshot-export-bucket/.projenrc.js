...
const cloud_backup_snapshot_export_bucket = new awscdk.AwsCdkConstructLibrary({
  ...
  publishToMaven: {
    javaPackage:
      'com.github.mongodb.cdk.mongodb_atlas_cloud_backup_snapshot_export_bucket',
  ...
  description:
    'Retrieves or creates cloud-backup-snapshot-export-buckets in any given Atlas organization'
