...
const cloud_backup_snapshot_export_job = new awscdk.AwsCdkConstructLibrary({
  ...
  publishToMaven: {
    javaPackage:
      'com.github.mongodb.cdk.mongodb_atlas_cloud_backup_snapshot_export_job',
    mavenArtifactId: 'mongodb-atlas-cloud-backup-snapshot-export-job',
    mavenGroupId: 'com.github.mongodb.cdk'
  },
  publishToGo: {
    moduleName: 'github.com/mongoDB',
    packageName: 'cloud-backup-snapshot-export-job'
  },
  publishToPypi: {
  ...
  description:
    'Retrieves or creates cloud-backup-snapshot-export-jobs in any given Atlas organization'
