...
const federated_settings_org_role_mapping = new awscdk.AwsCdkConstructLibrary({
  ...
  publishToMaven: {
    javaPackage:
      'com.github.mongodb.cdk.mongodb_atlas_federated_settings_org_role_mapping',
  ...
  description:
    'Retrieves or creates federated-settings-org-role-mappings in any given Atlas organization'
