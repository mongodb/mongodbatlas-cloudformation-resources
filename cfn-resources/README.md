...
| 46  | stream-instance                                        | ![Build](https://img.shields.io/badge/Beta-yellow) | [example](../examples/atlas-streams/stream-instance/stream-instance.json)                                                                                      | [./stream-instance/test](./stream-instance/test)  
| 47  | stream-connection                                        | ![Build](https://img.shields.io/badge/Beta-yellow) | [example](../examples/atlas-streams/stream-connection/stream-connection.json)                                                                                      | [./stream-connection/test](./stream-connection/test)  
                                                                            |
