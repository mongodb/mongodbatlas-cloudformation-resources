...
// TestConvertToMongoModel_ClearsAtlasReturnedThreshold verifies that when Atlas returns
// both MetricThreshold and Threshold (backward compatibility, see HELP-91242),
// ConvertToMongoModel clears whichever field is absent from the CFN model,
// preventing DUPLICATE_THRESHOLD_FIELD on the subsequent PUT.
