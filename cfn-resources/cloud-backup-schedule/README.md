...
For more information see: MongoDB Atlas API [Cloud Backup Schedule Endpoint](https://www.mongodb.com/docs/atlas/reference/api-resources-spec/#tag/Cloud-Backups-Schedule) Documentation.