...
In order to create the resource some prerequisites are required, check [Export Cloud Backup Snapshot Docs](https://www.mongodb.com/docs/atlas/backup/cloud-backup/export/) for more information
...
See the MongoDB Atlas API [Cloud-Backup-Export](https://www.mongodb.com/docs/atlas/reference/api-resources-spec/#tag/Cloud-Backup-Export) Documentation.
