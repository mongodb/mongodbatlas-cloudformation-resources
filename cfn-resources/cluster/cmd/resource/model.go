...
type Model struct {
	...
	GlobalClusterSelfManagedSharding          *bool                     `json:",omitempty"`
	...
	ConfigServerManagementMode                *string                   `json:",omitempty"`
	ReplicaSetScalingStrategy                 *string                   `json:",omitempty"`
	AcceptDataRisksAndForceReplicaSetReconfig *string                   `json:",omitempty"`
	RetainBackups                             *bool                     `json:",omitempty"`
	RedactClientLogData                       *bool                     `json:",omitempty"`
}
...
type ProcessArgs struct {
	...
	TransactionLifetimeLimitSeconds                       *int     `json:",omitempty"`
	ChangeStreamOptionsPreAndPostImagesExpireAfterSeconds *int     `json:",omitempty"`
	DefaultMaxTimeMS                                      *int     `json:",omitempty"`
}
...
type ConnectionStrings struct {
	...
	PrivateEndpoints                  []string `json:",omitempty"`
	PrivateEndpointsSrv               []string `json:",omitempty"`
	SRVShardOptimizedConnectionString []string `json:",omitempty"`
}
