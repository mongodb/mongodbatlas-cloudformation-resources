SSDLC Compliance Report: CloudFormation MongoDB::Atlas::cluster 2.6.1
=================================================================
...
- **Dependency Information**
  - See SBOM Lite manifests (CycloneDX in JSON format):
      - https://github.com/mongodb/mongodbatlas-cloudformation-resources/cfn-resources/cluster/compliance/v2.6.1/sbom.json
