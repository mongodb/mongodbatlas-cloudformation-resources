...
var CreateRequiredFields = []string{constants.OrgID, constants.ProjectID}
var UpdateRequiredFields = []string{constants.OrgID, constants.ProjectID, constants.ID}
var ReadRequiredFields = []string{constants.OrgID, constants.ProjectID, constants.ID}
var DeleteRequiredFields = []string{constants.OrgID, constants.ProjectID, constants.ID}
var ListRequiredFields = []string{constants.OrgID, constants.ProjectID}
...
func setup() {
	util.SetupLogger("mongodb-atlas-project-api-key")
}
...
func Create(req handler.Request, prevModel *Model, currentModel *Model) (handler.ProgressEvent, error) {
	...
	apiKeyInput := atlasSDK.CreateAtlasProjectApiKey{
		Desc:  currentModel.Description,
		Roles: currentModel.Roles,
	}
	apiKeyRequest := atlas.AtlasV2.ProgrammaticAPIKeysApi.CreateProjectApiKey(
		context.Background(),
...
func Update(req handler.Request, prevModel *Model, currentModel *Model) (handler.ProgressEvent, error) {
	...
	updateRequest := atlas.AtlasV2.ProgrammaticAPIKeysApi.UpdateApiKeyRoles(
		context.Background(),
		*currentModel.OrgId,
		*currentModel.Id,
		&apiKeyInput,
...
func Delete(req handler.Request, prevModel *Model, currentModel *Model) (handler.ProgressEvent, error) {
	...
	deleteRequest := atlas.AtlasV2.ProgrammaticAPIKeysApi.RemoveProjectApiKey(
		context.Background(),
		*currentModel.OrgId,
		*currentModel.Id,
	)
