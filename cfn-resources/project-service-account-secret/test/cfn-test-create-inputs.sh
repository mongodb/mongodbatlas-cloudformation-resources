...
function usage {
	...
	echo "Generates test input files for project service account secret"
}
...
serviceAccountName="cfn-test-project-sa-$(date +%s)-$RANDOM"
	...
	--output json
{
  ...
  "description": "CFN test project service account",
...
if [ -z "$clientId" ] || [ "$clientId" = "null" ]; then
	echo "Error creating project service account:"
