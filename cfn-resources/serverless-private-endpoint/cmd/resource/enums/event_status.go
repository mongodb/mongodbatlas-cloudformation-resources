...
const (
	...
	CreatingPrivateEndpoint   EventStatus = "CREATING_PRIVATE_ENDPOINT_SERVICE"
	InitiatingPrivateEndpoint EventStatus = "INITIATING_PRIVATE_ENDPOINT_SERVICE"
)
