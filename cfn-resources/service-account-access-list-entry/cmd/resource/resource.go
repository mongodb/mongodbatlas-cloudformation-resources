...
var (
	...
	ReadRequiredFields   = []string{constants.OrgID, constants.ClientID}
	DeleteRequiredFields = []string{constants.OrgID, constants.ClientID}
...
func setupRequest(req handler.Request, model *Model, requiredFields []string) (*util.MongoDBClient, *handler.ProgressEvent) {
	util.SetupLogger("mongodb-atlas-service-account-access-list-entry")
