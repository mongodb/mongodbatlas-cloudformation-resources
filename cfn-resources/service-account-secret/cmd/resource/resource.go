...
var (
	CreateRequiredFields = []string{constants.OrgID, constants.ClientID}
	ReadRequiredFields   = []string{constants.OrgID, constants.ClientID, constants.SecretID}
	DeleteRequiredFields = []string{constants.OrgID, constants.ClientID, constants.SecretID}
...
func setupRequest(req handler.Request, model *Model, requiredFields []string) (*util.MongoDBClient, *handler.ProgressEvent) {
	util.SetupLogger("mongodb-atlas-service-account-secret")
