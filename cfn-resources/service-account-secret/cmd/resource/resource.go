...
var (
	CreateRequiredFields = []string{"OrgId", "ClientId"}
	ReadRequiredFields   = []string{"OrgId", "ClientId", "SecretId"}
	DeleteRequiredFields = []string{"OrgId", "ClientId", "SecretId"}
	ListRequiredFields   = []string{"OrgId", "ClientId"}
)
