...
var (
	createRequiredFields           = []string{constants.ProjectID, constants.ProviderName, constants.Vendor}
	readUpdateDeleteRequiredFields = []string{constants.ProjectID, constants.ID}
