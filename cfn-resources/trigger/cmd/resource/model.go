...
// Trigger is autogenerated from the json schema
type Trigger struct {
	...
	AuthConfig               *Config                `json:",omitempty"`
	ScheduleConfig           *ScheduleConfig        `json:",omitempty"`
}

// Config is autogenerated from the json schema
type Config struct {
